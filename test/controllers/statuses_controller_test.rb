...
class StatusesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create status" do
    assert_difference('Status.count') do
      post statuses_url, params: { status: { comments: @status.comments, statusName: @status.statusName } }
    end
  ...
  test "should update status" do
    patch status_url(@status), params: { status: { comments: @status.comments, statusName: @status.statusName } }
